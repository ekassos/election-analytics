...
nah <- plot_usmap(data = final, regions = "states", values = "diff_1", labels = TRUE,
                label_color = "black") +
  ggtitle("Margin of popular vote victory in battleground states\nbased on our 2020 election predictionn") +
...
ggsave("name2.png", plot = nah, height = 6, width = 10)
